                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="ec-vendor-block-profile">
                                        ...
                                        <div class="card ">
                                            <form action="{{route('product.store')}}" method="POST" enctype="multipart/form-data" class="form-group  m-2">

                                                @csrf

                                             <div class="form-group  m-1 p-2">
                                                 <label for="">Title</label>
                                                 <input type="text" class="form-control" name='title'  placeholder="Enter your product title">
                                             </div>

                                             <div class="form-group  m-1 p-2">
                                                 <label for="">Description</label>
                                                 <textarea  id="" rows="3" class="form-control" name='description' placeholder="Enter your product description" ></textarea>
                                             </div>
                                             ...
                                             <div class="form-group  m-1 p-2">
                                                 ...
                                                 <input type="number" class="form-control" name='quantity' placeholder="Enter your product quantity avaliable">
                                             </div>
